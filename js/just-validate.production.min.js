...
!(function (e, i) {
  ...
  return class {
    ...
    addField(e, i, t) {
      ...
      return (
        (this.fields[l] = { elem: s, rules: i, isValid: void 0, config: t }),
        this.setListeners(s),
    ...
    renderFieldError(e, i) {
      ...
      (this.isValid = !1),
        n.elem.classList.add(
          ...c(
            (null == (l = n.config) ? void 0 : l.errorFieldCssClass) ||
              this.globalConfig.errorFieldCssClass
          )
        );
      const d = this.createErrorLabelElem(
        e,
        void 0 !== i ? i : n.errorMessage,
        n.config
      );
      this.renderFieldLabel(
        n.elem,
        d,
        null == (r = n.config) ? void 0 : r.errorsContainer
      ),
        this.isTooltip() &&
          this.tooltips.push(
            this.renderTooltip(
              n.elem,
              d,
              null == (a = null == (o = n.config) ? void 0 : o.tooltip)
                ? void 0
                : a.position
            )
          );
        ...
        this.isTooltip() &&
          this.tooltips.push(
            this.renderTooltip(
              r.groupElem,
              o,
              null == (l = null == (s = r.config) ? void 0 : s.tooltip)
                ? void 0
                : l.position
            )
          );
